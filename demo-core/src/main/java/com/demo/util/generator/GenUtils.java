package com.demo.util.generator;
...
import com.demo.util.common.DateUtil;
...
public class GenUtils {
	...
	public static List<String> getTemplates(){
		...
		templates.add("template/generator/Dao.xml.vm");
		...
		templates.add("template/generator/list.html.vm");
		templates.add("template/generator/list.js.vm");
		return templates;
	}
